...
//        选中那个，改变那个的颜色
        if (position == mSelect) {
            mHolder.mTvBankName.setTextColor(mContext.getResources().getColor(R.color.blue));
            mHolder.mTvBankCost.setTextColor(mContext.getResources().getColor(R.color.blue));
        } else {
            mHolder.mTvBankName.setTextColor(mContext.getResources().getColor(R.color.text_hot_color));
            mHolder.mTvBankCost.setTextColor(mContext.getResources().getColor(R.color.text_hot_color));
        }
        return convertView;
    }
